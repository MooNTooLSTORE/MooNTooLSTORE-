...
Эта инструкция поможет вам подключить вашего Telegram бота к панели управления MooNTooLSTORE.
...
6.  Вставьте скопированный токен в поле "Токен Telegram Бота" на вкладке "Настройки ТГ Бота" в этой панели.
...
1.  Убедитесь, что вы вставили и сохранили правильный токен на вкладке "Настройки ТГ Бота".
2.  На той же вкладке в разделе подключения нажмите кнопку **"Подключить бота (установить Webhook)"**.
3.  Система автоматически определит публичный URL вашего приложения и установит вебхук.
4.  Если все прошло успешно, вы увидите уведомление "Вебхук успешно установлен".
