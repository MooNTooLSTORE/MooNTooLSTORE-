...
import { Send, MessageSquare, PlusCircle, Trash2, StopCircle, Play, Loader2, ChevronLeft, ChevronRight } from "lucide-react";
            ...
            {campaignsTotalPages > 1 && (
                <div className="flex items-center justify-center space-x-2 pt-4">
                    ...
                    <span className="text-sm text-muted-foreground">
                        Стр. {campaignsPage} из {campaignsTotalPages}
                    </span>
                    <Button
                    variant="outline"
                    size="sm"
